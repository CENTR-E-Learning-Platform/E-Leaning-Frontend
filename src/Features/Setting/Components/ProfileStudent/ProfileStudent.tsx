...
const ProfileSkeleton = () => (
  <section className="profile-student animate-pulse">
    ...
    <div className="content-profile-student">
      <div className="flex items-center justify-center">
        <div className="w-[516px] max-w-full flex flex-col gap-[14px]">
          <div className="flex gap-[15px]">
            <div className="flex-1 flex flex-col gap-2">
              <div className="h-[14px] w-[70px] bg-gray-200 rounded-md" />
              <div className="h-[46px] w-full bg-gray-100 rounded-[8px]" />
            </div>
            <div className="flex-1 flex flex-col gap-2">
              <div className="h-[14px] w-[70px] bg-gray-200 rounded-md" />
              <div className="h-[46px] w-full bg-gray-100 rounded-[8px]" />
          ...
          <div className="flex flex-col gap-2">
            <div className="h-[14px] w-[50px] bg-gray-200 rounded-md" />
            <div className="h-[46px] w-full bg-gray-100 rounded-[8px]" />
          </div>
          <div className="flex flex-col gap-2">
            <div className="h-[14px] w-[50px] bg-gray-200 rounded-md" />
          ...
          <div className="flex flex-col gap-2">
            <div className="h-[14px] w-[120px] bg-gray-200 rounded-md" />
            <div className="h-[46px] w-full bg-gray-100 rounded-[8px]" />
          </div>
          <div className="flex flex-col gap-2">
            <div className="h-[14px] w-[140px] bg-gray-200 rounded-md" />
            <div className="h-[46px] w-full bg-gray-100 rounded-[8px]" />
          </div>
          <div className="flex justify-end mt-2">
            <div className="h-[42px] w-[130px] bg-gray-200 rounded-[8px]" />
          </div>
        </div>
      </div>
    </div>
