        ...
        return isMe ? (
          ...
          >
            <div className="flex flex-row items-start p-0 gap-[15.2px] w-[391.4px] max-w-[440.04px]">
              ...
              />
              <div className="">
                <div className="flex flex-col items-start pt-[13.39px] pr-[15px] pb-[14.63px] pl-[14.4px] bg-white shadow-[0px_1px_2px_rgba(0,0,0,0.05)] rounded-tr-[16px] rounded-br-[16px] rounded-bl-[16px]">
                  <p className="flex items-center font-['Poppins'] font-normal text-[15px] leading-[21.6px] text-[#2A2D34]">
                    {msg.content}
                  </p>
                </div>
