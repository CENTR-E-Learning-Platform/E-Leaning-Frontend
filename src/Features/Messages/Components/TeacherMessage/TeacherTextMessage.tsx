...
// export const TeacherTextMessage  = () => {
...
//             <p className="z-10 flex items-center w-[308.96px] font-['Poppins'] font-normal text-[15px] leading-[21.6px] text-white">
//               Of course Ali! I checked it already — you did well on most of the problems. Just a small mistake in question 4. Let me send you a correction note.
//             </p>
//           </div>
          ...
          {/* <div className="flex flex-row items-start p-0 gap-[15.2px] w-[391.4px] max-w-[440.04px]">
            <div className="flex flex-col items-end p-0 w-[345.8px]">
              ...
              <div className="relative flex flex-col items-start pt-[14.4px] pr-[20.5px] pb-[14.4px] pl-[15.2px] w-[345.8px] bg-[#525FE1] rounded-l-[16px] rounded-br-[16px] shadow-sm overflow-hidden">
                ...
                <p className="z-10 flex items-center font-['Poppins'] font-normal text-[15px] leading-[21.6px] text-white">
                  {msg.content}
                </p>
              </div>
