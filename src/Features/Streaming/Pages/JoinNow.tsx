  ...
  return (
    <div className="bg-[#2A2D34] h-[100vh] flex justify-center items-center">
      <div className="flex flex-col">
        ...
        <div className="bg-[#393D44] w-[450px] h-[300px] overflow-hidden rounded-[8px] flex justify-center items-center relative">
        ...
        <div className="flex justify-center items-center mt-[20px]">
          <button
            onClick={JoinRoom}
            className="w-[249px] h-[52px] bg-[#525FE1] rounded-[8px] text-[#F9FBFC] text-[18px] font-semibold cursor-pointer hover:bg-[#434db0] transition-colors"
          >
            Join now
          </button>
        </div>
