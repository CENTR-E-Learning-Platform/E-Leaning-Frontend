      ...
      {!click && (
        <div className= " h-[48px] bg-[#393D44] rounded-[43px] flex items-center p-[4px] cursor-pointer">
          <div className="flex justify-center">
            <img
              src={sene}
              className="w-[40px] h-[39px] rounded-full -ml-2 first:ml-0 border-[1px] border-[#F9FBFC]"
              alt=""
            />
            <img
              src={moz}
              className="w-[40px] h-[39px] rounded-full -ml-2 first:ml-2 border-[1px] border-[#F9FBFC]"
              alt=""
            />
            <img
              src={zeng}
