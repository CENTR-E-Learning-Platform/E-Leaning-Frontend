...
const participantList = ({onMute , }:any) => {
  return (
    <>
        <ParticipantComp rad = "rounded-t-[8px]" icon ={mic} color = "#F9FBFC" parg ="Mute Participant" />     
        <ParticipantComp 
        func = {onMute}
        rad = "" icon ={disMic}  color = "#F9FBFC" parg ="Disable Mic" />     
