...
export const MainContentSection: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center mt-[50px] px-4">
      <div className="flex flex-col w-full max-w-[1200px] items-start gap-9 pb-10">
        <HeroBanner 
          date="Nov 22, 2025"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 h-fit gap-[18px_12px] w-full">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-[30px] relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex flex-col w-full lg:w-[687px] items-end gap-9 relative">
            <div className="flex flex-col min-w-full lg:min-w-[643px] items-start gap-7 px-6 py-[30px] relative self-stretch w-full flex-[0_0_auto] bg-white rounded-lg border border-solid border-[#e8eaed]">
            ...
            <div className="flex flex-col items-start gap-7 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="flex flex-wrap items-center gap-6 relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col w-full lg:w-[483px] items-start gap-9 relative">
            <div className="flex flex-col min-w-full lg:min-w-[400px] items-start gap-7 px-6 py-[30px] w-full bg-white rounded-lg border border-solid border-[#e8eaed]">
              ...
              <div className="flex flex-col items-start gap-5 w-full">
                <div className="flex flex-col items-end justify-end gap-3 w-full">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
                    <div className="relative w-[60px] h-[60px] bg-[#daf3ff] rounded-xl flex items-center justify-center flex-shrink-0">
                      <div className="w-[27px] h-[42px] bg-blue-300" /> 
                    </div>
                    <div className="flex flex-col w-full sm:w-[229px] items-start gap-3">
                  ...
                  <div className="inline-flex items-center justify-center gap-2 w-full sm:w-[226px]">
            ...
            <div className="flex flex-col min-w-full lg:min-w-[400px] items-center justify-center gap-7 px-6 py-[30px] w-full bg-white rounded-lg border border-solid border-[#e8eaed]">
              <div className="flex items-center justify-between w-full">
                ...
                {messagesData.map((msg, index) => (
                  <div key={index} className="flex flex-col items-start gap-5 w-full">
                    <div className="flex items-center gap-2 w-full">
                      {msg.avatarImg ? (
                        <img className="w-[60px] h-[60px] object-cover rounded-full flex-shrink-0" alt={msg.name} src={tech} />
                      ) : (
                        <div className={`w-[60px] h-[60px] ${msg.avatarClass || 'bg-gray-200'} rounded-full relative flex-shrink-0`}>
                      ...
                      <div className="flex flex-col flex-1 items-start gap-1 overflow-hidden">
                        <span className="font-semibold text-[#2a2d34] text-lg leading-[13px]">{msg.name}</span>
                        <p className="font-medium text-[#6d7588] text-base leading-[13px] m-0 truncate w-full">{msg.message}</p>
                      </div>
                      <div className="flex flex-col items-center justify-center w-6 h-6 bg-[#525fe1] rounded-full text-white font-medium text-xs flex-shrink-0">
                        {msg.unread}
                      </div>
                    </div>
