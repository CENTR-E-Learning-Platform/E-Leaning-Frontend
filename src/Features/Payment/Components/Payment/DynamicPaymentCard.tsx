...
const DynamicPaymentCard = () => {
    ...
    if (!isInitialized.current) {
      ...
      try {
        const pixel = new (window as any).Pixel({
          ...
          clientSecret: testClientSecret?.toString(),
          paymentMethods: ['ًWallet','card'],
        ...
        console.error("Error Paymob:", error);
      }
    }
  ...
  return (
    <div className="w-[600px] min-h-[531px] rounded-[8px] border border-gray-300 p-[30px] bg-white">
      ...
      <div id="paymob-elements" className="w-[540px] min-h-[250px] mb-4 ">
      </div>
