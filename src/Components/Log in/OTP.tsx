...
const OTP = () => {
  ...
  const handelchange = (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
  ...
  const handelKeyBack = (e: React.KeyboardEvent<HTMLInputElement>, index: number) => {
      ...
      <section className="w-[50%] flex justify-center bg-[#F9FBFC]">
        <article className="flex flex-col items-center justify-center">
          ...
          <section className="mt-[12px]">
            ...
            <nav className="cursor-pointer flex justify-center items-center mt-[9px] text-[#2A2D34] w-[379px] h-[36px] border-[#6D7588] border-[1px] rounded-[4px]">
              <img className="w-[17px] me-[5px]" src={left_arrow} alt="Back arrow" />
